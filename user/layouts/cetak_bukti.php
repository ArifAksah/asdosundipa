          ...
          <div class="box box-widget widget-user-2">
            ...
            <?php foreach($terima as $trm) : ?>
              <ul class="nav nav-stacked">
                    ...
                    <li><a href="#">Diterima Jadi Asisten Dosen Pada Mata Kuliah <span class="direct-chat-text bg-teal"><i class=" fa-hand-o-righ"></i> <?php echo $trm['asdos_masuk'] ?></span></a></li>         
                    <li><a href="#">Diterima Jadi Asisten Dosen Pada Mata Kuliah <span class="direct-chat-text bg-teal"><i class=" fa-hand-o-righ"></i> <?php echo $trm['asdos_masuk2'] ?></span></a></li>         
              </ul>
              <?php endforeach ?>
            </div>
          </div>
