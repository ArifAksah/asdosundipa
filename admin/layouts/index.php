...
if (isset($_POST['terima'])) {
  if (terima($_POST) > 0) {
    echo "<script>
            alert('Calon Asdos Sudah Diterima');
...
<head>
  ...
  <title>ASDOS UNIVERSITAS DIPA MAKASSAR</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php?page=seleksi" class="logo">
      ...
      <span class="logo-lg"><b>ASDOS</b>UNIVERSITAS DIPA MAKASSAR</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index.php?page=regis"><i class="fa fa-circle-o"></i> Registrasi Asdos</a></li>
            <li><a href="index.php?page=viewasdos"><i class="fa fa-circle-o"></i> Daftar Asdos</a></li>
            <li><a href="index.php?page=seleksi"><i class="fa fa-circle-o"></i> Seleksi Asdos</a></li>
            <li><a href="index.php?page=terima"><i class="fa fa-circle-o"></i> Diterima Asdos</a></li>
          </ul>
        </li> 
      </ul>
    </section>
    ...
    <section class="content">
        ...
        <?php
                ...
                if (isset($_GET['page'])) {
                    ...
                    elseif($page == "viewasdos") {
                      include '../viewasdos.php';
                    } 
                    elseif($page == "edit") {
                      include 'edit.php';
                    }
...
<script>
  $(function () {
    ...
    var bar_data = {
      data : [['Praktikum Web', '<?php echo $total_prakweb; ?>'], ['Praktikum Mobile', '<?php echo $total_prakmobile ?>'], ['Praktikum Algoritma', '<?php echo $total_prakalgo; ?>']],
      color: '#3c8dbc'
    }
